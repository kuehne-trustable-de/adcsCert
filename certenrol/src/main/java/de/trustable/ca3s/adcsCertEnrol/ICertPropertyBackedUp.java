 ...
 *
 * <p>uuid({728AB338-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB338-217D-11DA-B2A4-000E7BBB2B09}")
public interface ICertPropertyBackedUp extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0x60030000)</p>
     * <p>vtableId(14)</p>
     * @param BackedUpValue [in] {@code Boolean}
     */
    @ComMethod(name = "InitializeFromCurrentTime", dispId = 0x60030000)
    void InitializeFromCurrentTime(Boolean BackedUpValue);
     ...
     */
    @ComMethod(name = "Initialize", dispId = 0x60030001)
    void Initialize(Boolean BackedUpValue,
            java.util.Date Date);
     ...
     * <p>vtableId(16)</p>
     */
    @ComProperty(name = "BackedUpValue", dispId = 0x60030002)
    Boolean getBackedUpValue();
            
    /**
     * <p>id(0x60030003)</p>
     * <p>vtableId(17)</p>
     */
    @ComProperty(name = "BackedUpTime", dispId = 0x60030003)
    java.util.Date getBackedUpTime();
