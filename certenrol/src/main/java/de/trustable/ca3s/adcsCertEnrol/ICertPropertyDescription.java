...
/**
 * Certificate Description Property Interface
 *
 * <p>uuid({728AB331-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB331-217D-11DA-B2A4-000E7BBB2B09}")
public interface ICertPropertyDescription extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0x60030000)</p>
     * <p>vtableId(14)</p>
     * @param strDescription [in] {@code String}
     */
    @ComMethod(name = "Initialize", dispId = 0x60030000)
    void Initialize(String strDescription);
            
    /**
     * <p>id(0x60030001)</p>
     * <p>vtableId(15)</p>
     */
    @ComProperty(name = "Description", dispId = 0x60030001)
