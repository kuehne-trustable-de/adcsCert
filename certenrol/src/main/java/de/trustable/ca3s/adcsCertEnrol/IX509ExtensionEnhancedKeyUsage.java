...
/**
 * X.509 Enhanced Key Usage Extension Interface
 *
 * <p>uuid({728AB310-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB310-217D-11DA-B2A4-000E7BBB2B09}")
public interface IX509ExtensionEnhancedKeyUsage extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
    ...
    void InitializeEncode(IObjectIds pValue);
     ...
     * <p>vtableId(14)</p>
     */
    @ComProperty(name = "EnhancedKeyUsage", dispId = 0x60030002)
    IObjectIds getEnhancedKeyUsage();
