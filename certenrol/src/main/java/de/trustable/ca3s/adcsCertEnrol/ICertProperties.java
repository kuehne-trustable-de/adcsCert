...
/**
 * Certificate Property Collection Interface
 *
 * <p>uuid({728AB32F-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
...
public interface ICertProperties extends IUnknown, IRawDispatchHandle, IDispatch {
    ...
    ICertProperty getItemByIndex(Integer Index);
     ...
     * <p>id(0x2)</p>
     * <p>vtableId(10)</p>
     * @param pVal [in] {@code ICertProperty}
     */
    @ComMethod(name = "Add", dispId = 0x2)
    void Add(ICertProperty pVal);
     ...
     */
    @ComMethod(name = "InitializeFromCertificate", dispId = 0x60020006)
