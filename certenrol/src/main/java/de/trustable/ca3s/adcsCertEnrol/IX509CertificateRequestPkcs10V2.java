...
/**
 * X.509 Certificate Request Pkcs10 Interface v2
 *
 * <p>uuid({728AB35B-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB35B-217D-11DA-B2A4-000E7BBB2B09}")
public interface IX509CertificateRequestPkcs10V2 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
