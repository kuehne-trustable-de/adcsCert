 ...
 *
 * <p>uuid({728AB31B-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB31B-217D-11DA-B2A4-000E7BBB2B09}")
public interface IX509ExtensionSmimeCapabilities extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0x60030000)</p>
     * <p>vtableId(12)</p>
     * @param pValue [in] {@code ISmimeCapabilities}
     */
    @ComMethod(name = "InitializeEncode", dispId = 0x60030000)
    void InitializeEncode(ISmimeCapabilities pValue);
     ...
     * <p>vtableId(14)</p>
     */
    @ComProperty(name = "SmimeCapabilities", dispId = 0x60030002)
    ISmimeCapabilities getSmimeCapabilities();
