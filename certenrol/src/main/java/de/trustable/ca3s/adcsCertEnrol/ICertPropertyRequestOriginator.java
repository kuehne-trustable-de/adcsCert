 ...
 *
 * <p>uuid({728AB333-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB333-217D-11DA-B2A4-000E7BBB2B09}")
public interface ICertPropertyRequestOriginator extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0x60030000)</p>
     * <p>vtableId(14)</p>
     * @param strRequestOriginator [in] {@code String}
     */
    @ComMethod(name = "Initialize", dispId = 0x60030000)
    void Initialize(String strRequestOriginator);
            
    /**
     * <p>id(0x60030001)</p>
     * <p>vtableId(15)</p>
     */
    @ComMethod(name = "InitializeFromLocalRequestOriginator", dispId = 0x60030001)
     ...
     * <p>vtableId(16)</p>
     */
    @ComProperty(name = "RequestOriginator", dispId = 0x60030002)
