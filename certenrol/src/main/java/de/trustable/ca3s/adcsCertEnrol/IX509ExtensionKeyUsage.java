...
/**
 * X.509 Key Usage Extension Interface
 *
 * <p>uuid({728AB30F-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB30F-217D-11DA-B2A4-000E7BBB2B09}")
public interface IX509ExtensionKeyUsage extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0x60030000)</p>
     * <p>vtableId(12)</p>
     * @param UsageFlags [in] {@code X509KeyUsageFlags}
     */
    @ComMethod(name = "InitializeEncode", dispId = 0x60030000)
    void InitializeEncode(X509KeyUsageFlags UsageFlags);
     ...
     * <p>vtableId(14)</p>
     */
    @ComProperty(name = "KeyUsage", dispId = 0x60030002)
