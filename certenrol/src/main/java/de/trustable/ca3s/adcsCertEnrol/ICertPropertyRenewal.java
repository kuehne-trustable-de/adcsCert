 ...
 *
 * <p>uuid({728AB33A-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB33A-217D-11DA-B2A4-000E7BBB2B09}")
public interface ICertPropertyRenewal extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>vtableId(14)</p>
     * @param Encoding [in] {@code EncodingType}
     * @param strRenewalValue [in] {@code String}
     */
     ...
     * @param strCertificate [in] {@code String}
     */
    @ComMethod(name = "InitializeFromCertificateHash", dispId = 0x60030001)
    void InitializeFromCertificateHash(Boolean MachineContext,
            EncodingType Encoding,
            String strCertificate);
     ...
     * @param Encoding [in] {@code EncodingType}
     */
    @ComProperty(name = "Renewal", dispId = 0x60030002)
    String getRenewal(EncodingType Encoding);
