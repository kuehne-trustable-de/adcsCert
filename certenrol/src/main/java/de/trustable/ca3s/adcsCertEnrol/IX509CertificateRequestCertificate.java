...
/**
 * X.509 Certificate Request Certificate Interface
 *
 * <p>uuid({728AB343-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB343-217D-11DA-B2A4-000E7BBB2B09}")
public interface IX509CertificateRequestCertificate extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * @param pPublicKey [in] {@code IX509PublicKey}
     */
    @ComMethod(name = "CheckPublicKeySignature", dispId = 0x60040000)
     ...
     * <p>vtableId(61)</p>
     */
    @ComProperty(name = "Issuer", dispId = 0x60040001)
     ...
     * <p>vtableId(63)</p>
     */
    @ComProperty(name = "NotBefore", dispId = 0x60040003)
     ...
     */
    @ComProperty(name = "NotBefore", dispId = 0x60040003)
    void setNotBefore(java.util.Date param0);
            
    /**
     * <p>id(0x60040005)</p>
     * <p>vtableId(65)</p>
     */
    @ComProperty(name = "NotAfter", dispId = 0x60040005)
     ...
     */
    @ComProperty(name = "NotAfter", dispId = 0x60040005)
    void setNotAfter(java.util.Date param0);
     ...
     * @param Encoding [in, optional] {@code EncodingType}
     */
    @ComProperty(name = "SerialNumber", dispId = 0x60040007)
     ...
     */
    @ComProperty(name = "SerialNumber", dispId = 0x60040007)
    void setSerialNumber(EncodingType Encoding,
            String param1);
     ...
     * <p>vtableId(69)</p>
     */
    @ComProperty(name = "SignerCertificate", dispId = 0x60040009)
