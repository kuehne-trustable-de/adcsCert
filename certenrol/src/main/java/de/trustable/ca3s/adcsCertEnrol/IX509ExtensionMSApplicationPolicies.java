...
/**
 * X509ExtensionMSApplicationPolicies Interface
 *
 * <p>uuid({728AB321-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB321-217D-11DA-B2A4-000E7BBB2B09}")
public interface IX509ExtensionMSApplicationPolicies extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0x60030000)</p>
     * <p>vtableId(12)</p>
     * @param pValue [in] {@code ICertificatePolicies}
     */
    @ComMethod(name = "InitializeEncode", dispId = 0x60030000)
    void InitializeEncode(ICertificatePolicies pValue);
     ...
     * <p>vtableId(14)</p>
     */
    @ComProperty(name = "Policies", dispId = 0x60030002)
    ICertificatePolicies getPolicies();
