 ...
 *
 * <p>uuid({728AB332-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB332-217D-11DA-B2A4-000E7BBB2B09}")
public interface ICertPropertyAutoEnroll extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
    ...
    void Initialize(String strTemplateName);
            
    /**
     * <p>id(0x60030001)</p>
     * <p>vtableId(15)</p>
     */
    @ComProperty(name = "TemplateName", dispId = 0x60030001)
