...
/**
 * X.509 Simple Computer Enrollment Protocol Interface v2
 *
 * <p>uuid({728AB364-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB364-217D-11DA-B2A4-000E7BBB2B09}")
public interface IX509SCEPEnrollment2 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * @param Encoding [in, optional] {@code EncodingType}
     */
    @ComMethod(name = "CreateChallengeAnswerMessage", dispId = 0x60030000)
    String CreateChallengeAnswerMessage(EncodingType Encoding);
            
    /**
     * <p>id(0x60030001)</p>
     * <p>vtableId(30)</p>
     * @param Flags [in] {@code X509SCEPProcessMessageFlags}
     * @param strResponse [in] {@code String}
     * @param Encoding [in, optional] {@code EncodingType}
     */
    @ComMethod(name = "ProcessResponseMessage2", dispId = 0x60030001)
    X509SCEPDisposition ProcessResponseMessage2(X509SCEPProcessMessageFlags Flags,
            String strResponse,
            EncodingType Encoding);
     ...
     * <p>vtableId(31)</p>
     */
    @ComProperty(name = "ResultMessageText", dispId = 0x60030002)
     ...
     * <p>vtableId(32)</p>
     */
    @ComProperty(name = "DelayRetry", dispId = 0x60030003)
    DelayRetryAction getDelayRetry();
            
    /**
     * <p>id(0x60030004)</p>
     * <p>vtableId(33)</p>
     */
    @ComProperty(name = "ActivityId", dispId = 0x60030004)
     ...
     */
    @ComProperty(name = "ActivityId", dispId = 0x60030004)
    void setActivityId(String param0);
