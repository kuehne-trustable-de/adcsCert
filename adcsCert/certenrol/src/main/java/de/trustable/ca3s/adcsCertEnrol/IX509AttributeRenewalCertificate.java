 ...
 *
 * <p>uuid({728AB326-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB326-217D-11DA-B2A4-000E7BBB2B09}")
public interface IX509AttributeRenewalCertificate extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * @param Encoding [in] {@code EncodingType}
     */
    @ComProperty(name = "RenewalCertificate", dispId = 0x60030002)
