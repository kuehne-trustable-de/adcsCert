...
/**
 * Certificate Friendly Name Property Interface
 *
 * <p>uuid({728AB330-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB330-217D-11DA-B2A4-000E7BBB2B09}")
public interface ICertPropertyFriendlyName extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0x60030000)</p>
     * <p>vtableId(14)</p>
     * @param strFriendlyName [in] {@code String}
     */
    @ComMethod(name = "Initialize", dispId = 0x60030000)
    void Initialize(String strFriendlyName);
            
    /**
     * <p>id(0x60030001)</p>
     * <p>vtableId(15)</p>
     */
    @ComProperty(name = "FriendlyName", dispId = 0x60030001)
