...
/**
 * X.509 Extensions Attribute Interface
 *
 * <p>uuid({728AB324-217D-11DA-B2A4-000E7BBB2B09})</p>
 */
@ComInterface(iid="{728AB324-217D-11DA-B2A4-000E7BBB2B09}")
public interface IX509AttributeExtensions extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     ...
     * <p>id(0x60030000)</p>
     * <p>vtableId(10)</p>
     * @param pExtensions [in] {@code IX509Extensions}
     */
    @ComMethod(name = "InitializeEncode", dispId = 0x60030000)
    void InitializeEncode(IX509Extensions pExtensions);
     ...
     * <p>vtableId(12)</p>
     */
    @ComProperty(name = "X509Extensions", dispId = 0x60030002)
